...
function sendmail()
{
    $name = "Gurpreet Singh";  // Name of your website or yours
    $to = "gur.coder@gmail.com";  // mail of reciever
    $subject = "Tutorial or any subject";
    $body = "Send Mail Using PHPMailer - MS The Tech Guy";
    $from = "gur.coder@gmail.com";  // you mail
    $password = "Singh_0904";  // your mail password
